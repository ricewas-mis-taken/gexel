...
export default function PacmanIntro({ onNext }) {
          ...
          {phase === "intro" ? (
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.5, textAlign: "justify" }}>
                To prove your worthiness of the RAM stick, defeat the eternal ghosts of Pac-Man to construct your very own RAM stick. For every ghost you slay, you build a part of the stick, but for every one of your valiant deaths, the ghosts take one back. You have three chances, so play wisely…
              </p>
            ...
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.4, textAlign: "justify" }}>
                Originally released by Namco in 1980, Pac-Man was created by Toru Iwatani to appeal to a wider audience than the space shooters that dominated arcades at the time. It became one of the most successful and influential arcade games ever made, helping define the maze-chase genre and becoming a global pop culture icon. Unknown to many, the four ghosts each have unique personalities: <span style={{color:"#ff0000"}}>Blinky (red)</span> aggressively chases Pac-Man, <span style={{color:"#ffb8ff"}}>Pinky (pink)</span> tries to ambush him, <span style={{color:"#00ffff"}}>Inky (cyan)</span> uses unpredictable movements, and <span style={{color:"#ffb852"}}>Clyde (orange)</span> alternates between chasing and wandering away.
              </p>

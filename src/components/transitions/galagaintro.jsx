...
export default function GalagaIntro({ onNext }) {
          ...
          {phase === "intro" ? (
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.5, textAlign: "justify" }}>
                Wade through the hordes of Galactic Butterflies to penetrate the safe. Inside, you will find the first of 4 artifacts;the reactor core. Beware of the dive-bombers!
              </p>
            ...
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.4, textAlign: "justify" }}>
                Galaga was developed and released by Namco in 1981 as the sequel to Galaxian. THe game expanded on the original by providing better graphics, introducing enemy formations, diving attack patterns, and smarter enemies. Galaga defined the golden-age of shoot 'em up arcade games and is considered one of the most influential fixed shooters ever made.
              </p>

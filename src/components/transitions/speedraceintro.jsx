...
export default function SpeedraceIntro({ onNext }) {
  ...
  useEffect(() => {
    ...
    grad.addColorStop(0, "rgba(255,80,60,0.45)");
    grad.addColorStop(0.3, "rgba(180,40,30,0.25)");
    grad.addColorStop(0.7, "rgba(60,10,10,0.15)");
    ...
    coneGrad.addColorStop(0, "rgba(255,120,80,0.18)");
    coneGrad.addColorStop(1, "rgba(200,60,40,0.04)");
    ...
    <AppShell>
      ...
      <div style={{ flex: 1, background: "#000", position: "relative", display: "flex", alignItems: "center", justifyContent: "center", paddingBottom: 120 }}>
        ...
        <div style={{
          ...
          <img src={kyranImg} alt="Kyran" style={{ width: 180, imageRendering: "pixelated" }} />
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: "#111",
            borderTop: `4px solid ${boxColor}`, borderLeft: `4px solid ${boxColor}`, borderRight: `4px solid ${boxColor}`, borderBottom: "4px solid #111",
          ...
          {phase === "intro" ? (
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.5, textAlign: "justify" }}>
                I'm not much of a talker so here's the deal. You beat my time of 30 seconds while collecting 5 medallions and I'll give you what you want. Chop chop.
              </p>
            ...
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.4, textAlign: "justify" }}>
                Due to time limitations, I was not able to replicate Sega's Turbo, which is considered one of the greatest arcade racers of all time. Before the age of Turbo, top-down racers like Atari's Gran Trak 10 (1974) and Sprint 2 (1976) defined the genre, letting players steer a car around a fixed track viewed from directly above. Turbo would go on to revolutionize racing games in 1981 by faking a forward-scrolling 3D perspective through sprite-scaling, a trick that paved the way for the pseudo-3D racers of the decade after it. This game is a small tribute to those humbler top-down roots that came before the illusion of speed took over.
              </p>

...
export default function TetrisIntro({ onNext }) {
          ...
          {phase === "intro" ? (
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.5, textAlign: "justify" }}>
                {playerName || "Cubicle-dweller"}! No one has been able to open the Thousand-Year apple for well, a thousand years, but I have a plan. I have cast a spell on the Tetris game. Each completed row will become a snake that eats at the apple, but beware; if you play too slowly or reach the top, you will lose. Good luck!
              </p>
            ...
            <>
              <p style={{ margin: "0 0 20px", fontFamily: "'PokemonClassic', monospace", fontSize: 14, color: "#fff", lineHeight: 1.9, letterSpacing: 0.4, textAlign: "justify" }}>
                Tetris was created in 1984 by Alexey Pajitnov, a Soviet software engineer, who built it on an Elektronika 60 while exploring how falling pentomino-like shapes could tile a board. It spread across the Eastern Bloc before a tangled licensing battle brought it west, and its 1989 pack-in release on the Game Boy turned it into a global phenomenon that helped sell the handheld itself. Decades later it remains one of the best-selling video games of all time, and the "Tetris effect" it inspired, seeing falling blocks even with your eyes closed, is still studied by psychologists today.
              </p>

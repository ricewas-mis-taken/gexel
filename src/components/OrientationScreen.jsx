...
import { GameCanvas, RamBar } from "./MainGameScreen";
...
export function PixelWizard({ scale = 6 }) {
  return (
...
const STEPS = [
  {
    text: "This is the Gexel page, advance by having fun and defeating the evil IT's control over these legendary arcade games!",
  },
  {
    text: "This is the RAM stick; right now there is only a faint outline of what it will look like. Through the various challenges you will face, you shall construct it. This RAM is the only weapon that can damage IT management.",
    highlight: "ram",
  },
  {
    text: "Here, you can see your RAM-coins. Collect these as you complete challenges; each and every one will have a profound effect on your final fight with IT.",
    highlight: "coins",
  },
  {
    text: "Well thats all for now, good luck!",
  },
];

export default function OrientationScreen({ onNext })
{
    ...
    <>
      <AppShell showCoins={false}>
        ...
        >
          ...
          <div style={{ position: "absolute", inset: 0, pointerEvents: "none", ...(highlight === "ram" ? liveStyle : dimStyle) }}>
            <RamBar />
          </div>
          <div style={{ position: "absolute", inset: 0, pointerEvents: "none", ...(highlight === "coins" ? liveStyle : dimStyle) }}>
            <CoinCounter />
          </div>
          ...
          <div style={{
            ...
            width: 380, zIndex: 10,
            background: "#0a1a0a",
            border: "4px solid #2ea84a",
            borderRadius: 4,
            boxShadow: "0 0 0 2px #000, 0 0 24px #2ea84a88",
            ...
            <button onClick={handleNext} style={{
              ...
              color: "#9933ff", fontSize: 13,
              fontFamily: "'PokemonClassic', monospace",
              cursor: "pointer", letterSpacing: 1,
              filter: "drop-shadow(0 0 6px #7733cc)",
